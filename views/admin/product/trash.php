               ...
               <tr class="datarow">
                  ...
                  <td>
                     ...
                     <div class="function_style">
                        <a href="index.php?opt=product&cat=restore&id=<?= $product->id; ?>" class="text-primary mx-1">
                           <i class="fa fa-undo"></i>
                        </a>
                        <a href="index.php?opt=product&cat=destroy&id=<?= $product->id; ?>" class="text-danger mx-1">
                  ...
                  <td>
                     <?php $brand = Brand::find($product->brand_id);
                     echo $brand->name;
                     ?>
                  </td>
