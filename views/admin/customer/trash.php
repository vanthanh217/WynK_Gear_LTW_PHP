               ...
               <tr class="datarow">
                  ...
                  <td>
                     ...
                     <div class="function_style">
                        <a href="index.php?opt=customer&cat=restore&id=<?= $customer->id ?>" class="text-primary mx-1">
                           <i class="fa fa-undo"></i>
                        </a>
                        <a href="index.php?opt=customer&cat=destroy&id=<?= $customer->id ?>" class="text-danger mx-1">
