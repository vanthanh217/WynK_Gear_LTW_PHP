         ...
         <tbody>
            <?php foreach ($pages as $page) : ?>
               <tr class="datarow">
                  ...
                  <td>
                     <div class="name">
                        <a href="index.php?opt=page&cat=edit&id=<?= $page->name; ?>">
                           <?= $page->name; ?>
                        </a>
                     </div>
                     <div class="function_style">
                        <a href="index.php?opt=page&cat=restore&id=<?= $page->id; ?>" class="text-primary mx-1">
                           <i class="fa fa-undo"></i>
                        </a>
                        <a href="index.php?opt=page&cat=destroy&id=<?= $page->id; ?>" class="text-danger mx-1">
