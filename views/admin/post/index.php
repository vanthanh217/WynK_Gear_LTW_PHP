      ...
      <div class="row mt-3 align-items-center">
         <div class="col-6">
            <ul class="manager">
               ...
               <li>
                  <a href="index.php?opt=post&cat=trash">
                  ...
                  <td>
                     ...
                     <div class="function_style">
                        <?php if ($post->status == 1) : ?>
                           <a href="index.php?opt=post&cat=status&id=<?= $post->id; ?>" class="text-success mx-1">
                              <i class="fa fa-toggle-on"></i>
                           </a>
                        <?php else : ?>
                           <a href="index.php?opt=post&cat=status&id=<?= $post->id; ?>" class="text-danger mx-1">
